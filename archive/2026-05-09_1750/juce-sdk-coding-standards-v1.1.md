                               ...
                               juce::MidiBuffer& midi)
{
    ...
    const int channelsToProcess = std::min(totalInputChannels, totalOutputChannels);
...
This example is intentionally simple. Real products with sidechains, multiple buses, mono-to-stereo processing, surround layouts, or instruments MUST define and test their own bus/channel mapping policy.
...
7. Run sanitiser jobs.
8. Build VST3 artefact.
9. Run VST3 validator.
10. Package artefact.
11. Optional: smoke-test in a plug-in host.
12. Sign/notarise where applicable.
